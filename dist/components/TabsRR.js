...
function Tabs2(props) {
  ...
  var tab = url_tab_code || data.selected || data.list[0].code;
...
function fixTabsSelected(data, url_tab_code, updateTabs, updateSerchParams) {
  if (url_tab_code === null) {
    // url でタブがセットされていない場合
    var first_tab_code = data.list[0].code;
